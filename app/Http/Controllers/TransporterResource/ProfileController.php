...
class ProfileController extends Controller
{
    ...
    {   
        ...
        if(empty($Transporter->device_type)){
            $Transporter->device_type = "";
        }
        if(empty($Transporter->device_id)){
            $Transporter->device_id = "";
        }
        if(empty($Transporter->device_token)){
            $Transporter->device_token = "";
        }
        return $Transporter;
    }
    ...
    public function update(Request $request)
    {
        ...
        try{
            ...
            if($request->hasFile('avatar')) {
                $Transporter->avatar = asset('public/storage/'.$request->avatar->store('transporter/profile'));
            }
            $Transporter->save();
            if(empty($Transporter->device_id)){
                $Transporter->device_id = "";
