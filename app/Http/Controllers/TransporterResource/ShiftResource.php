...
//             $i = 0;
// 			foreach($TransporterShift as $TransporterShifts){
// 				$TransporterShiftEnd = $TransporterShifts['end_time'];
// 				$TransporterShiftDelete = $TransporterShifts['deleted_at'];
// 				if(!empty($TransporterShiftEnd)){
// 					$TransporterShift[$i]['end_time'] = $TransporterShiftEnd;
// 				}else{
// 					$TransporterShift[$i]['end_time'] = "";
// 				}
// 				if(!empty($TransporterShiftDelete)){
// 					$TransporterShift[$i]['deleted_at'] = $TransporterShiftDelete;
// 				}else{
// 					$TransporterShift[$i]['deleted_at'] = "";
// 				}
// 				$i++;
// 			}
    ...
    {
        // $i = 0;
        // foreach($request->user()->vehicles as $vehicles){
        //     $vehicle_delete = $vehicles['deleted_at'];
        //     if(!empty($vehicle_delete)){
        //         $request->user()->vehicles[$i]['deleted_at'] = $vehicle_delete;
        //     }else{
        //         $request->user()->vehicles[$i]['deleted_at'] = "";
        //     }
        //     $i++;
        // }
