       ...
       try {
            ...
            if($request->has('price')){
                ...
                if($Order->transporter_id){
                    ...
                    (new SendPushNotification)->sendPushNotificationToProvider($Order->transporter_id,$description,$page =['page'=>'userorder','status'=>$Order->status,'dispute_status'=>$Order->dispute,'order_id'=>$Order->id]);
                }
                OrderTiming::create([
                    'order_id' => $Order->id,
                    'status' => 'CANCELLED'
