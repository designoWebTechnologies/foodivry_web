...
use App\Notifications\TransporterRegisteredNotification;
    ...
    {   
        ...
        try {
            ...
            if($request->hasFile('avatar')) {
                $User['avatar'] = asset('public/storage/'.$request->avatar->store('transporter/profile'));
            }
            $User['latitude'] = $request->latitude;
            $User['longitude'] = $request->longitude;
            $User['address'] = $request->address;
            $User = Transporter::create($User);
            $User->notify(new TransporterRegisteredNotification($User));
    ...
    {   
        ...
        try {
            ...
            if($request->has('settle')){
                ...
                (new SendPushNotification)->sendPushNotificationToProvider($User->id,$push_message,$page =['page'=>'userorder']);
                ...
                if($request->hasFile('avatar')) {
                    $Update['avatar'] = asset('public/storage/'.$request->avatar->store('transporter/profile'));
                }
                $User->update($Update);
            }
