...
class AddonsResource extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if($request->hasFile('avatar')) {
                $Addon['avatar'] = asset('public/storage/'.$request->avatar->store('addons'));
            }
    ...
    public function update(Request $request, $id)
    {
       $this->validate($request, [
        ...
        try {
            ...
            $Update = $request->all();
            if($request->hasFile('avatar')) {
                $Update['avatar'] = asset('public/storage/'.$request->avatar->store('addons'));
            } else {
                unset($Update['avatar']);
            }
    ...
    public function destroy(Request $request,$id)
    {
         try {
            ...
            if($request->ajax()){
                    return response()->json(['message' => trans('inventory.addons.not_remove')]);
            }
