                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.products.edit', $Product->id) }}?shop={{Request::get('shop')}}" class="table-btn btn btn-icon btn-success"><i class="fa fa-pencil-square-o"></i></a>
                                         <button  class="table-btn btn btn-icon btn-danger" form="resource-delete-{{ $Product->id }}" ><i class="fa fa-trash-o" onclick="return confirm('Are you sure you want to delete this product?');"></i></button> 
                                        @endif
