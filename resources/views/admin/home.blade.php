            ...
            <div class="card-body">
                <div class="media">
                    ...
                    <div class="p-2 bg-gradient-x-warning white media-body">
                        ...
                        <h5 class="text-bold-400"><i class="ft-arrow-down"></i> {{Setting::get('currency')}}{{@$OrderIncomeToday}}</h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="media">
                    ...
                    <div class="p-2 bg-gradient-x-success white media-body">
                        ...
                        <h5 class="text-bold-400"><i class="ft-arrow-up"></i> {{Setting::get('currency')}}{{@$OrderIncomeMonthly}}</h5>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div id="recent-buyers" class="list-group height-300 position-relative">
                    ...
                    <a href="#" class="list-group-item list-group-item-action media no-border">
                        <div class="media-left">
                            ...
                            @else
                            src="{{asset('public/assets/admin/images/portrait/small/avatar-s-7.png')}}"
                            @endif
                             alt="Generic placeholder image"><i></i>
                            </span>
                        </div>
                        <div class="media-body">
                            <h6 class="list-group-item-heading">{{$Order->user->name}} <span class="font-medium-4 float-xs-right pt-1">{{Setting::get('currency')}}{{$Order->invoice->net}}</span></h6>
...
<div class="row match-height">
    <div class="col-xl-12 col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="card-block">
                    <p>Total paid invoices <span style="color:green;">{{Setting::get('currency').$paid_total}}</span>, unpaid <span style="color:red;">{{Setting::get('currency').$unpaid_total}}</span>. <span class="float-xs-right"><a href="{{url('admin/orders?list=true&all=1')}}" >Invoice Summary <i class="ft-arrow-right"></i></a></span></p>
                </div>
                    ...
                    <table id="recent-orders" class="table table-hover mb-0 ps-container ps-theme-default">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-truncate">{{ucfirst(@$Order->user->name)}}</td>
                                <td class="text-truncate">{{ucfirst(@$Order->shop->name)}}</td>
                                ...
                                <td class="text-truncate">{{Setting::get('currency')}}{{$Order->invoice->net}}</td>
                            </tr>
                            @empty
...
@section('scripts')
 <!-- BEGIN PAGE LEVEL JS-->
    ...
    <script type="text/javascript">
        //var data = "{{json_encode($complete_cancel)}}";
        var data = [ 
     ...
     <script src="{{ asset('public/assets/admin/js/scripts/pages/dashboard-ecommerce.min.js') }}" type="text/javascript"></script>
@endsection