                            ...
                            <div class="card-block">
                                ...
                                <div class="col-sm-9">
                                    <div class="card-btm pending-btm">
                                        ...
                                        {{substr($Transporter->phone, 1,3).'******'.substr($Transporter->phone, -2)}}
                                        @endif
...
<script src="{{ asset('public/assets/admin/vendors/js/charts/gmaps.min.js')}}" type="text/javascript"></script>
<!-- BEGIN PAGE LEVEL JS-->
