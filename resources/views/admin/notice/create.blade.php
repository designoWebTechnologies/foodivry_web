...
<div class="card">
    ...
    <div class="card-body collapse in">
        <div class="card-block">
            <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.notice.store') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="form-group col-xs-12 mb-2">
                    ...
                    <textarea id="notice"  class="form-control "  name="notice"  required ></textarea>
                ...
                <div class="form-group col-xs-12 mb-2">
                    ...
                    <input type="text" id="note"  class="form-control "  name="note" value="" />
                        @if ($errors->has('note'))
                            <span class="help-block">
