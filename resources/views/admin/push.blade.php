...
@section('styles')
    <link href="{{asset('public/assets/admin/css/bootstrap-datepicker.css')}}" rel="stylesheet">
    <link href="{{asset('public/assets/admin/css/bootstrap-timepicker.css')}}" rel="stylesheet">
    <style type="text/css">
...
@section('content')
    ...
    <div class="content-area py-1 bg-white">
        <div class="container-fluid ">
            ...
            <div class="content-area py-1 bg-white" style="margin-top: 40px;">
            <div class="container-fluid">
	        <div class="box box-block">
...
<script src="{{asset('public/assets/admin/js/bootstrap-timepicker.js')}}"></script>
...
<script src="https://maps.googleapis.com/maps/api/js?key={{Setting::get('GOOGLE_API_KEY')}}&libraries=places&callback=initAutocomplete"
        async defer></script>
@endsection