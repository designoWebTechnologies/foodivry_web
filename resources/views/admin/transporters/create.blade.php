...
<div class="card">
    ...
    <div class="card-body collapse in">
        <div class="card-block">
            <form class="form-horizontal" id="transporter_form" role="form" method="POST" action="{{ route('admin.transporters.store') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
...
<link rel="stylesheet" type="text/css" href="{{ asset('public/assets/css/easy-autocomplete.min.css')}}">
<style type="text/css">
...
<script src="{{ asset('public/assets/js/jquery.easy-autocomplete.min.js') }}" type="text/javascript"></script>
<script type="text/javascript">
    ...
    var options = {
      ...
      url: "{{asset('public/assets/js/countryCodes.json')}}",
