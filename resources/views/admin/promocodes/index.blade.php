                                            ...
                                            @foreach($Promocodes as $key=>$Promocode)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button  class="table-btn btn btn-icon btn-danger" form="resource-delete-{{ $Promocode->id }}" onclick="return confirm('Are you sure you want to delete this promocode?');"><i class="fa fa-trash-o"></i></button> 
                                                        @endif
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row">
                                            <div class="bg-img order-img" style="background-image: url(../public/assets/img/product-1.jpg);"></div>
                                        </th>
                                        <td>Burger Bistro</td>
                                        <td>$100</td>
                                    </tr>
