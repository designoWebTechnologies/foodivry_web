    ...
    <div class="container margin_60_35">
        <div class="row">
            ...
            <div class="col-md-7 col-md-offset-1 text-right hidden-sm hidden-xs">
                <img src="{{asset('public/assets/user/img/devices.jpg')}}" alt="" class="img-responsive">
            </div>
        </div>
        <!-- End row -->
        <hr class="more_margin">
        <div class="main_title">
            <h2 class="nomargin_top">Quick Product Quality feautures</h2>
            <p>
        ...
        <div class="row">
            <div class="col-md-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="feature">
                    ...
                    <h3><span>+ 1000</span> Grocery Shop</h3>
                    <p>
