...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Foodivry</title>
    <link rel="stylesheet" href="{{asset('css/pdfstyle.css')}}" media="all" />
  </head>
  <body>
    <header class="clearfix">
      <div id="logo">
        <img src="{{asset('public/images/logo.jpg')}}"  height="200px" width="200px">
      </div>
      <div id="company">
        <h2 class="name">Foodivry</h2>
        <div>H-182 ,Ground, H Block, Sector 63, Noida, Uttar Pradesh 201301</div>
        <div>(+1) 7651827761</div>
        <div><a href="mailto:support@foodivry.com">support@foodivry.com</a></div>
      </div>
      </div>
    </header>
    <main>
