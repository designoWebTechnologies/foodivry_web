                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('product_position') ? ' has-error' : '' }}">
                            ...
                            <input type="number" class="form-control" value="{{$Product->position}}" id="product_position" name="product_position" required autofocus/>
                        ...
                        <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                            ...
                            <input type="file" accept="image/*" name="avatar[]" class="dropify" id="image" aria-describedby="fileHelp" data-default-file="{{ image($Product->images) }}">
                        ...
                        <div class="form-group{{ $errors->has('featured') ? ' has-error' : '' }}">
                            ...
                            <input type="checkbox" value="1" class="form-control" @if($Product->featured) checked  @endif id="featured" name="featured"/>
                             <label for="featured">@lang('inventory.product.featured_position')</label>
                            <input type="number" min="0" class="form-control" value="{{$Product->featured_position}}" id="featured_position" name="featured_position"/>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                            <label for="price">Price</label> (In {{Setting::get('currency')}})
