<div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
        <div class="main-menu-content">
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                ...
                <li class="@if(Request::segment(2)=='profile') active  @endif nav-item"><a href="{{route('shop.profile.index')}}"><i class="fa fa-cutlery"></i><span data-i18n="" class="menu-title">@lang('menu.shop.restaurant')</span></a>
                    
                </li>
                @if(Setting::get('PRODUCT_ADDONS')==1)
                <li class="@if(Request::segment(2)=='addons') active  @endif nav-item"><a href="#"><i class="fa fa-shopping-bag"></i><span data-i18n="" class="menu-title">@lang('menu.shop.addons')</span></a>
                    <ul class="menu-content">
                        <li><a href="{{route('shop.addons.index')}}" class="menu-item">@lang('menu.shop.addons_list')</a></li>
                        <li><a href="{{route('shop.addons.create')}}" class="menu-item">@lang('menu.shop.add_addons')</a></li>
                    </ul>
                </li>
                @endif
                 <li class="@if(Request::segment(2)=='categories') active  @endif nav-item"><a href="#"><i class="fa fa-shopping-bag"></i><span data-i18n="" class="menu-title">@lang('menu.shop.category')</span></a>
                    <ul class="menu-content">
                        <li><a href="{{route('shop.categories.index')}}" class="menu-item">@lang('menu.shop.category_list')</a></li>
                        <li><a href="{{route('shop.categories.create')}}" class="menu-item">@lang('menu.shop.add_category')</a></li>
                    </ul>
                </li>
                 <li class="@if(Request::segment(2)=='products') active  @endif nav-item"><a href="#"><i class="fa fa-shopping-bag"></i><span data-i18n="" class="menu-title">@lang('menu.shop.product')</span></a>
                    <ul class="menu-content">
