                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            @if(Setting::get('DEMO_MODE')==1)
                                value="{{$Shop->email}}"
                            @else
                                value="{{substr($Shop->email, 0, 1).'****'.substr($Shop->email, strpos($Shop->email, "@"))}}"
                        ...
                        <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                            ...
                            <input id="phone" type="text" class="form-control" name="phone" @if(Setting::get('DEMO_MODE')==1)
                            value="{{$Shop->phone}}"
                            @else
                            value="{{substr($Shop->phone, 0, 5).'****'}}"
                            @endif
                             required autofocus  >
                            @if ($errors->has('phone'))
                            <span class="help-block">
                        ...
                        <?php $array = $Shop->timings->toArray(); ?>
                         ...
                         <div class="form-group">
                            <label for="password-confirm">@lang('form.restaurant_open')</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group{{ $errors->has('offer_min_amount') ? ' has-error' : '' }}">
                                    <label for="offer_min_amount">@lang('form.Min_Amount')</label> (In {{Setting::get('currency')}})
