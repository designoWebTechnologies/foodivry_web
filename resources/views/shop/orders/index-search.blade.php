                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="card-btm row m-0">
                                    ...
                                    @elseif($Order->status=='PROCESSING')
                                     ...
                                     @elseif($Order->status=='REACHED')
                                      <span class="tag batch">@lang('order.dispatcher.reached')</span>
                                     @elseif($Order->status=='PICKEDUP')
                                      <span class="tag batch">@lang('order.dispatcher.packup')</span>
                                     @elseif($Order->status=='ARRIVED')
                                      <span class="tag batch">@lang('order.dispatcher.arrived')</span>
    ...
    @if(count($Orders)>0)
        ...
        var MainComponent = React.createClass({
            ...
            componentDidMount: function(){
                $.ajax({
                  url: "{{url('shop/orders?order_id='.Request::get('order_id'))}}&q=1",
                  type: "GET"})
