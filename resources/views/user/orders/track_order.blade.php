...
<section style="background:#efefe9;">
    <div class="container">
        <div class="row">
            ...
            <div class="board">
                <h2>@lang('user.create.delivery_tracking')<!-- <sup>™</sup> --></h2>
                    <div class="board-inner">
                        <ul class="nav nav-tabs" id="myTab">
                            ...
                            <li class="ORDERED @if(@$Order->status == 'ORDERED') active @endif " >
                                ...
                                <br> 
                                <p class="track-tab">@lang('user.create.order_placed')</p>
                            </li> 
                            ...
                            <li class="RECEIVED @if($Order->status == 'RECEIVED') active @endif" >
                                ...
                                <br> 
                                <p class="track-tab">@lang('user.create.order_confirmed')</p>
                            </li>
                            <li class="ASSIGNED @if($Order->status == 'ASSIGNED') active @endif " >
                                ...
                                <br> 
                                <p class="track-tab">@lang('user.create.order_assigned')</p>
                            </li>
                            <li class="PROCESSING @if($Order->status == 'PROCESSING') active @endif " >
                                ...
                                <br> 
                                <p class="track-tab">@lang('user.create.order_processing')</p>
                            </li>
                            <li class="REACHED @if($Order->status == 'REACHED') active @endif">
                                ...
                                <br> <p class="track-tab">@lang('user.create.order_reached')</p>
                            </li>
                            <li class="PICKEDUP @if($Order->status == 'PICKEDUP') active @endif ">
                                ...
                                <br> <p class="track-tab">@lang('user.create.order_pickedup')</p>
                            </li> 
                            <li class="ARRIVED @if($Order->status == 'ARRIVED') active @endif ">
                                ...
                                <br><p class="track-tab">@lang('user.create.order_arrived')</p>
                            </li>
                            <li class="COMPLETED @if($Order->status == 'COMPLETED') active @endif" >
                                ...
                                <br> <p class="track-tab">@lang('user.create.order_completed')</p>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                ...
                <!-- End box_style_1 -->
                    <div class="theiaStickySidebar">
                        <div id="cart_box">
                            <h3>@lang('user.your_order') <i class="icon_cart_alt pull-right"></i></h3>
                            <table class="table table_summary">
                                <thead>
                                    <th>@lang('user.create.name')</th>
                                    <th>@lang('user.create.quantity')</th>
                                    <th>@lang('user.create.per_price')</th>
                                    <th>@lang('user.create.price')</th>
                                </thead>
                                <tbody>
                            ...
                            <hr>
                            <a href="{{ url('user/chat?order_id='.$Order->id) }}" class="btn btn-danger btn-darken-3" target="_blank"  >@lang('user.create.chat')</a>
                            ...
                            <table class="table table_summary">
                                <tbody>
                                    <tr>
                                        <td>
                                            @lang('user.create.order_custom_note'):- 
                                            <span class="pull-right">{{$Order->note}}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            @lang('user.create.order_delivered_date'):- 
                                            <span class="pull-right">{{$Order->delivery_date}}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            @lang('user.create.subtotal') <span class="pull-right">{{currencydecimal($Order->invoice->gross)}}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            @lang('user.create.tax') <span class="pull-right">{{currencydecimal($Order->invoice->tax)}}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                           @lang('user.create.delivery_fee')  <span class="pull-right">{{currencydecimal(Setting::get('delivery_charge'))}}</span>
                                        </td>
                                    </tr>
                                    <tr>@if($Order->invoice->tax != '')
                                <td >
                                     @lang('user.create.wallet_detection')
                                ...
                                @endif
                                    ...
                                    <tr>
                                        <td>
                                           @lang('user.discount') <span class="pull-right">-{{currencydecimal($Order->invoice->discount)}}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="total">
                                            @lang('user.create.total') <span class="pull-right">{{currencydecimal($Order->invoice->net - $Order->invoice->wallet_amount)}}</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <a class="btn_full" href="{{url('payment')}}?order_id={{$Order->id}}">@lang('user.create.pay_now')</a>
                            @endif
                    ...
                    @if(@$Order->reviewrating && @$Order->reviewrating->shop_id)
                        ...
                        @else
                            <div class="col-md-6">
                                ...
                                <label>@lang('user.reviews')</label>
                                <textarea class="form-control" name="comment"></textarea>
                                </div>
                                <div class="form-group">
                                <label>@lang('user.create.ratings')</label>
                                <input type="number" min="1" max="5" value="" name="rating" class="form-control" />
                                </div>
                                <button type="submit" class="btn btn-primary pull-right" >@lang('user.create.submit')</button>
                                </form>
                            </div> 
...
//mapLocation();
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key={{Setting::get('GOOGLE_API_KEY')}}&libraries=places&callback=mapLocation" ></script>
    @if($Order->status == 'CANCELLED' || $Order->status == 'COMPLETED')
