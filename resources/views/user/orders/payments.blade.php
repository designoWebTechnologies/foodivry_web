                            ...
                            <div class="col-md-9 col-sm-12 col-xs-12">
                                <div class="profile-right">
                                    ...
                                    <div class="profile-right-head">
                                        <h4>@lang('user.create.payments')</h4>
                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="wallet-money-inner row m-0">
                                                    ...
                                                    <div class="statement pull-right">
                                                        <a href="#statement-modal" class="theme-link state-link" data-toggle="modal" data-target="#statement-modal">@lang('user.create.view_statement')</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="saved-cards-box row m-0">
                                                        ...
                                                        <div class="saved-cards-box-right pull-right">
                                                            <a href="#" class="card-delete theme-link" data-toggle="modal" data-target="#delete-modal">@lang('user.create.delete')</a>
                                                        </div>
                                                    </div>
                                                </div>
