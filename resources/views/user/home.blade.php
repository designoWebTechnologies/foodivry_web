...
@section('content')
 <!-- Content ================================================== -->
        ...
        <div class="row">
            ...
            <div class="profile-right-col col-md-9 white_bg">
                <div class="profile-right white_bg row">
                    <div class="prof-head">
                        <h3 class="prof-tit">@lang('user.home.upcoming_order')</h3>
                    </div>
                    <div class="prof-content">
                            ...
                            <div class="row">
                                <div class="col-md-9 col-sm-9">
                                    <div class="desc">
                                        ...
                                        <button class="pur-link submit itemlist" data-id="{{$Order->id}}">Purchasing List</button>
                                ...
                                <div class="col-md-3 col-sm-3">
                                    <div class="go_to">
                                        <div>
                                             <a   href="{{url('user/chat?order_id='.$Order->id)}}" target="_blank" class="btn_1">@lang('user.create.chat')<span class="chatbtn" id="chat_{{$Order->id}}">0</span></a>
                                        <br/><br/><br/><br/>
                                            <a href="{{url('track/order/'.$Order->id)}}" class="btn_1">@lang('user.create.track')</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        @empty
                        <div>@lang('user.home.no_order_found')!</div>
                        @endforelse
                        <!-- End strip_list-->
                    </div>
                </div>
    ...
    <div class="modal fade" id="product-list" tabindex="-1" role="dialog" aria-labelledby="product-list" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content modal-popup" style="background-color: #fff;">
                <a href="#" class="close-link"><i class="icon_close_alt2"></i></a>
                <form action="#" class="">
                    <h3 class="pop-tit">@lang('user.home.product_list')</h3>
                    <table class="table table-striped cart-list ">
                        <thead>
                            <tr>
                                <th>
                                    @lang('user.create.item')
                                </th>
                                <th>
                                    @lang('user.home.qty')
                                </th>
                                <th>
                                    @lang('user.home.price')
                                </th>
                                <th>
                                   @lang('user.total')
                                </th>
