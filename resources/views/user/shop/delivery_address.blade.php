                                    ...
                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                        <div class="payment-content-left">
                                            <ul class="nav nav-tabs payment-tabs" role="tablist">
                                               ...
                                               <!--@if($ripple_response !='')-->
                                               <!-- <li>-->
                                               <!--     <a href="#ripple" aria-controls="ripple" role="tab" data-toggle="tab" class="payment_mode_type" data-id="ripple"><span class="pay-icon"><img src="{{asset('public/assets/user/img/ripple.png')}}"></span> @lang('user.ripple')</a>-->
                                               <!-- </li>-->
                                               <!-- @endif-->
                                               <!-- @if($ether_response !='')-->
                                               <!-- <li>-->
                                               <!--     <a href="#ethereum" aria-controls="ethereum" role="tab" data-toggle="tab" class="payment_mode_type" data-id="ethereum" ><span class="pay-icon"><img src="{{asset('public/assets/user/img/eth.png')}}"></span> @lang('user.ethereum')</a>-->
                                               <!-- </li>-->
                                               <!-- @endif-->
                                               <!--  <li>
                   ...
                   <!--  <p class="coupon-txt">Pay via Visa Signature Cards &amp; get additional 10x Reward Points on every  $150 spent. Use Code KIU10X</p> -->
                    <div class="coupon-details">
                        <div class="coupon-det-box row m-0">
                            ...
                            <div class="col-xs-6 p-l-0">
                                @if($promocode->promocode_type == 'amount')
                                    <p class="coupon-det-txt coupon-det-txt2">{{currencydecimal($promocode->discount)}}</p>
                                @else
                                    <p class="coupon-det-txt coupon-det-txt2">{{round($promocode->discount)}}% off</p>
                                @endif
                            </div>
                        </div>
                        <div class="coupon-det-box row m-0">
