                        ...
                        @endif
                            ...
                            <div class="desc">
                                <div class="thumb_strip">
                                    ...
                                    @else
                                        <img src="{{asset('public/assets/user/img/shop-logo/thumb-grocery-1.png')}}" alt="">
                                    @endif
                                </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key={{Setting::get('GOOGLE_API_KEY')}}&libraries=places&callback=initMap" ></script>
<script src="{{ asset('public/assets/user/js/map.js')}}"></script>
<script src="{{ asset('public/assets/user/js/infobox.js')}}"></script>
@endsection