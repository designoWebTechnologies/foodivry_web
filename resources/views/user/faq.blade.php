                                    ...
                                    <div class="profile-coupons">
                                        ...
                                        <div class="profile-coupons-block row">
                                            ...
                                            <div class="helppanel">
                                                ...
                                                @else
                                                <br/>
                                                <p><b>Do you charge for delivery?</b><br/>
Delivery fee varies from city to city and is applicable if order value is below a certain amount. Additionally, certain restaurants might have fixed delivery fees. Delivery fee (if any) is specified on the 'Review Order' page.</p>
                                                <b> ** Note: Demo Content ** </b>
                                                <br/>
                                                @endif
                                            </div>
                                                <!-- Coupon Box Starts -->
