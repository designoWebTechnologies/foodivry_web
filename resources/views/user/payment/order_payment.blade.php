                    ...
                    @forelse($cards as $card)
                     @if($card->is_default)
                        ...
                        <div class="payment_select">
                            ...
                            @if($card->brand=='Visa')
                                <img src="{{asset('public/assets/user/img/visa.png')}}" alt="" data-retina="true" class="" style="float: right;">
                            @elseif($card->brand == 'mastercard')
                            <img src="{{asset('public/assets/user/img/master.png')}}" alt="" data-retina="true" class="" style="float: right;">
                            @endif
                        </div>
                    @else
                         <div class="payment_select">
