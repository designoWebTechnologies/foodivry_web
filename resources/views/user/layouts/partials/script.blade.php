...
<!-- Login Sidebar Starts -->
        ...
        <div class="aside-contents">
            ...
            <div class="login-content">
                    ...
                    <div class="login-form-sec">
                        <h5 class="login-tit">@lang('user.footer.login')</h5>
                        ...
                        <div class="or">@lang('user.create.or')</div>
                        ...
                        {{ csrf_field() }}
                            <!-- <div class="form-group">
                                <label>@lang('user.create.phone')</label>
                            ...
                            <div class="col-xs-3">
                                <input type="text" id="login_code" name="login_code" class="form-control country_code" placeholder="Code">
                            </div>
                            <div class="col-xs-9 p-l-0">
                                <input type="phone" class="form-control phone-number" id="phone" name="phone" value="" placeholder="@lang('user.enter_phone')" maxlength="10" onkeypress="return phoneNumberKey(event);" required>
                            </div> 
                                                
                        </div>
                            <div class="print-error-msg alert-danger error_phone"></div> 
                            <div class="form-group">
                                <label>@lang('user.create.password')</label>
                                <input type="password" id="login_password" name="password" placeholder="@lang('user.enter_password')" class="form-control">
                            </div>
                            <div class="print-error-msg alert-danger error_password"></div> 
                            <a href="javascript:void(0);" class="theme-link forgot-link">@lang('user.create.forgot_your_password')</a>
                            <button type="button" class="login-btn login_btn">@lang('user.footer.login')</button>
                         </form>
                    </div>
                    ...
                    <div class="forgot-form-sec">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('password.email') }}">
                            {{ csrf_field() }}
                            <h5 class="login-tit">@lang('user.create.forgot_your_password')</h5>
                            <div class="form-group">
                                <label>@lang('user.create.email')</label>
                                <input type="email" name="email" value="{{ old('email') }}" required class="form-control">
                            </div>
                            <button type="submit" class="login-btn forgot-btn ">@lang('user.create.submit')</button>
                        </form>
                         <button type="button" class="forgot-btn login-btn login-link">@lang('user.footer.login')</button>
                    </div>
        ...
        <div class="aside-contents">
            ...
            <div class="login-head row">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <h5 class="login-tit">@lang('user.create.sign_up')</h5>
                </div>
            ...
            <div class="login-content">
                <form  class="popup-form" method="POST" id="register_form" action="{{ url('/register') }}">
                    ...
                    <div id="first_step">
                        ...
                        <input type="text" class="form-control form-white dm" placeholder="Name" id="dname" name="name" value="{{ old('name') }}">
                        <input type="email" class="form-control form-white dm" id="demail" name="email"  value="{{ old('email') }}" placeholder="@lang('user.create.email')">
                        <div class="form-group row">
                            <div class="col-xs-12">
                                <label>@lang('user.create.phone')</label>
                            </div>
                            ...
                            <div class="col-xs-3">
                                <input type="text" id="country_code" name="country_code" class="country_code form-control" placeholder="Code">
                            </div>
                            <div class="col-xs-9 p-l-0">
                        ...
                        <button type="button" onclick="smsLogin();" class="login-btn mobile_verfication">@lang('user.create.verify_phone')</button>
                    ...
                    <div id="second_step" style="display: none;">
                        ...
                        <div class="form-group">
                            <label>@lang('user.create.name')</label>
                        ...
                        <div class="form-group"  id="password1">
                         ...
                         <div class="form-group" id="password2">
                            <label>@lang('user.create.confirm_password')</label>
    ...
    <!-- Signup Sidebar Ends -->
 <script src="{{ asset('public/assets/user/js/jquery.easy-autocomplete.js') }}" type="text/javascript"></script>
 <link rel="stylesheet" type="text/css" href="{{ asset('public/assets/user/css/easy-autocomplete.min.css')}}">
    <style type="text/css">
...
var options = {
  ...
  url: "{{asset('public/assets/user/js/countryCodes.json')}}",
 ...
 var my_otp='';
    ...
    $('.register_btn').on('click',function(){ 
        ...
        if($('#check_2').is(':checked')){
            ...
            $("#register_form .print-error-msg").html('');
            $("#register_form .print-error-msg").show();
            $("#register_form").find(".error_terms").html('Please Check Terms & Conditions'); 
        }
    });
...
<!-- Edit Profile Starts -->
    <div class="aside right-aside location" id="edit-profile-sidebar">
        <div class="aside-header">
            <span class="close" data-dismiss="aside"><i class="ion-close-round"></i></span>
            <h5 class="aside-tit">@lang('user.create.edit_profile')</h5>
        </div>
        <div class="aside-contents">
            <div class="edit-profile-box">
                <form action="{{url('/profile')}}" class="edit-profile-section" method="POST" enctype= "multipart/form-data" >
                    {{csrf_field()}}
                    <div class="edit-details">
                        <h6 class="edit-details-tit">@lang('user.create.phone')</h6>
                        <div class="row m-0">
                            <p class="pull-left edit-details-txt">{{Auth::user()->phone}}</p>
                            <a href="javascript:void(0);" class="edit-link theme-link pull-right">@lang('user.create.change')</a>
                        </div>
                    </div>
                    <div class="edit-form-sec">
                        ...
                        <button class="cmn-btn">@lang('user.create.update')</button>
                    </div>
                </form>
            </div>
            <div class="edit-profile-box">
                <form action="{{url('/profile')}}" class="edit-profile-section" method="POST" enctype= "multipart/form-data" >
                    {{csrf_field()}}
                    <div class="edit-details">
                        <h6 class="edit-details-tit">@lang('user.create.email')</h6>
                        <div class="row m-0">
            ...
            @if(Auth::user()->login_by == 'manual')
                <div class="edit-profile-box">
                    <form action="{{url('/profile')}}" class="edit-profile-section" method="POST" enctype= "multipart/form-data" >
                        {{csrf_field()}}
                        <div class="edit-details">
                            <h6 class="edit-details-tit">@lang('user.create.password')</h6>
                            <div class="row m-0">
...
@if(Request::segment(1)=='restaurant' && Request::has('myaddress'))
 <!-- Location Sidebar Starts -->
     <div  class="aside location" id="location-sidebar">
        <div class="aside-header">
            <span class="close" data-dismiss="aside"><i class="ion-close-round"></i></span>
            <h5 class="aside-tit">@lang('user.create.save_address')</h5>
        </div>
        <div class="aside-contents">
            <form action="{{route('useraddress.store')}}" method="POST" id="comon-form" class="common-form">
                ...
                <div class="input-section">
                    <div class="form-group">
                        <label>@lang('user.create.address')</label>
                        <input class="form-control addr-mapaddrs" id="pac-input" name="map_address" type="text" value="{{Session::get('search_loc')}}">
                <input type="hidden" id="latitude" name="latitude" value="{{ Session::get('latitude') }}" readonly required>
                <input type="hidden" id="longitude" name="longitude" value="{{ Session::get('longitude') }}" readonly required>
                    </div>
                    <div class="form-group">
                        <label>@lang('user.create.door_no')</label>
                        <input class="form-control addr-building" name="building" type="text" value="">
                    </div>
                    <div class="form-group">
                        <label>@lang('user.create.landmark')</label>
                        <input class="form-control addr-landmark" name="landmark" type="text">
                    </div>
                    <div class="form-group">
                        <label>@lang('user.create.address_type')</label>
                ...
                <button class="add-address-btn">@lang('user.create.save') &amp; @lang('user.create.proceed')</button>
            </form>
        </div>
    </div>
...
@if(Request::segment(1)=='restaurants' || Request::segment(1)=='restaurant') 
  <!-- Nav Location Sidebar Starts -->
    <div class="aside location" id="nav-location-sidebar">
        <div class="aside-header">
            <span class="close" data-dismiss="aside"><i class="ion-close-round"></i></span>
            <h5 class="aside-tit">@lang('user.create.search_location')</h5>
        </div>
        <div class="aside-contents">
            ...
            <a href="#" class="gps row m-0 my_map_form_current">
                ...
                <div class="gps-right">
                    <h6 class="gps-tit">@lang('user.create.gps_location')</h6>
                    <p class="gps-txt">@lang('user.create.using_gps')</p>
                </div> 
            </a>
...
@endif
@if(empty($map))
<script src="https://maps.googleapis.com/maps/api/js?key={{Setting::get('GOOGLE_API_KEY')}}&libraries=places&callback=initMap" async defer></script>
@endif
