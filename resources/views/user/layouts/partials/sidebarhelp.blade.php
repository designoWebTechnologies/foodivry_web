<div class="profile-left col-md-3 col-sm-12 col-xs-12">
    <ul class="nav nav-tabs payment-tabs" role="tablist">
        ...
        <!--    <a href="{{url('orders')}}"><span><i class="mdi mdi-shopping"></i></span> Help With Orders</a>-->
        <!--</li>-->
        ...
        <!--    <a href="{{url('useraddress')}}"><span><i class="mdi mdi-map-marker-outline"></i></span> Conversation Archive</a>-->
        <!--</li>-->
    </ul>
</div>